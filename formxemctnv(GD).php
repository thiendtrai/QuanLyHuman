...
<script>
    document.addEventListener('DOMContentLoaded', function() {
     ...
     const currentChucvu = '<?php echo $row['chucvu']; ?>';

     if (currentChucvu === 'Nhân Viên') {
        
        addOption(chucvuSelect, 'Trưởng Phòng');
    } else if (currentChucvu === 'Trưởng Phòng') {
       
        addOption(chucvuSelect, 'Nhân Viên');
    }
